...
//
//     final tvShowDetail = tvShowDetailFromJson(jsonString);

import 'dart:convert';

TvShowDetail tvShowDetailFromJson(String str) =>
    TvShowDetail.fromJson(json.decode(str));

String tvShowDetailToJson(TvShowDetail data) => json.encode(data.toJson());
